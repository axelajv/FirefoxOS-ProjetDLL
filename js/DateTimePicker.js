...
;(function ( $, window, document, undefined ) {
		...
		var defaults = {
			...
			shortMonthNames: ["Jan", "Fev", "Mar", "Avr", "Mai", "Jui", "Jui", "Aoû", "Sep", "Oct", "Nov", "Dec"],
			fullMonthNames: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Decembre"],
			formatHumanDate: formatHumanDate,
		
			titleContentDate: "Set Date",
			titleContentTime: "Set Time",
			titleContentDateTime: "Selectionner Date & Heure",
